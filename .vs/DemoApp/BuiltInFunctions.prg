...
// Location: C:\Projects\XSError\.vs\DemoApp\BuiltInFunctions.prg
...
/// <param name="cond">The condition. This should evaluate to TRUE or FALSE.</param>
/// <param name="trueExpr">The expression to return when the condition evaluates to TRUE.</param>
/// <param name="falseExpr">The expression to return when the condition evaluates to FALSE.</param>
...
/// <param name="trueExpr">The expression to return when the condition evaluates to TRUE.</param>
/// <param name="falseExpr">The expression to return when the condition evaluates to FALSE.</param>
FUNCTION IF(cond AS LOGIC, trueExpr as USUAL, falseExpr as USUAL) AS USUAL
